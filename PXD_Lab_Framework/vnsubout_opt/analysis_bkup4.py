...
def analysis(logger, module, path, analysispath, current_source_ranges, return_dict, ped_mask_path=None, limit_low=20, limit_high=250, w_opt=1 ):
    """
    ...
    #b) Pedestal maps
    for index, value in enumerate(current_source_ranges):
        fig3, axx = pl.subplots(2, 2, figsize=(8,12))
