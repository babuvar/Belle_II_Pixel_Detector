...
def performMeasurement(logger, dhc, dhe, path, asicpairs, framenr, freq, useExternalTrigger, sync, daqport, dataport,
                       controlport, useDHC, useprogresspv, return_dict, event_daq, event_triggering, current_source, current_source_list,
                       current_source_ranges):
    create_context()
        ...
        for current_source_Val in current_source_ranges:
            ...
            try:
                ...
                data = daq.record_memorydump(asicpair=asicpairs, framenr=framenr, dhc=dhc.name, dhePrefix=dhe,
                                         ...
                                         readdata=False, useprogresspv=useprogresspv)
