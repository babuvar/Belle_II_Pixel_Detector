...
name_ring ='/Data2/source_scan_samples/W41_IF_2018_03_28_001/hv-72000_drift-4000_clear-off4000/clusterdb.h5'
...
#FFT
ring_fft=fftpack.fft2(ring_map)

ring_fft2= ring_fft.copy()
ring_fft2[keeph:768-(1+keeph),:]=0
ring_fft2[:,keepv:240-(1+keepv)]=0

ring_fft2[0,0]=0; ring_fft2[0,239]=0; ring_fft2[767,0]=0; ring_fft2[767,239]=0
ring_fft2[1,0]=0; ring_fft2[1,239]=0; ring_fft2[766,0]=0; ring_fft2[766,239]=0
ring_fft2[2,0]=0; ring_fft2[2,239]=0; ring_fft2[765,0]=0; ring_fft2[765,239]=0


ring_new = fftpack.ifft2(ring_fft2).real


figu=pl.figure(figsize=(30,15))
pl.subplot(131)
pl.imshow(ring_map); pl.colorbar(); pl.title('diffmap')
pl.subplot(132)
pl.imshow(ring_new); pl.colorbar(); pl.title('diffmap (fft-denoised)')
pl.subplot(133)
pl.imshow(np.abs(ring_fft2[:keeph, :keepv])); pl.colorbar(); pl.title('fft')
