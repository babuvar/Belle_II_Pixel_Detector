...
wafer='W57-OF1'; r_start=5; r_end=762
name_ring = '/Data2/W57-OF1/source_scan/2021_04_08_004/hv-56000_drift-4000_clear-off4000/clusterdb.h5'
name_flat = '/Data2/W57-OF1/source_scan/2021_04_08_004/hv-70000_drift-4000_clear-off3000/clusterdb.h5'
...
ring_map = ring_data.root.H2041.hitmap[r_start-1 : r_end, c_start-1 : c_end]
ring_data.close()
flat_data = tables.open_file(name_flat, mode="r")
flat_map = flat_data.root.H2041.hitmap[r_start-1 : r_end, c_start-1 : c_end]
flat_data.close()
...
Input_dir='/Data2/W57-OF1/source_scan'
names = {}
for Directory in os.listdir(Input_dir):
    input_dir =  os.path.join(Input_dir,Directory)
...
for name, fullname in names.items():
    ...
    curr_map = curr_data.root.H2041.hitmap[r_start-1 : r_end, c_start-1 : c_end]
    curr_data.close()
    ...
    #Codeblock if one wants to see the variation of f.o.m for each hitmap. Slows down the program quite a bit.
    #vary 'a'
